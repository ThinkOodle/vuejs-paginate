  ...
  <ul :class="containerClass" v-if="!noLiSurround">
    ...
    <li v-if="!(firstPageSelected() && hidePrevNext)" :class="[prevClass, firstPageSelected() ? disabledClass : '']">
      <a
        ...
        :tabindex="firstPageSelected() ? -1 : 0"
      >
        <slot name="prevText" v-if="hasPrevContent"></slot>
    ...
    <li
      ...
      :key="i"
    >
      <a v-if="page.breakView" :class="[pageLinkClass, breakViewLinkClass]" tabindex="-1">
        <slot name="breakViewContent">{{ breakViewText }}</slot>
      </a>
      <a href="javascript:void(0)" v-else-if="page.disabled" :class="pageLinkClass">{{ page.content }}</a>
      <a
        href="javascript:void(0)"
        v-else
    ...
    <li v-if="!(lastPageSelected() && hidePrevNext)" :class="[nextClass, lastPageSelected() ? disabledClass : '']">
      ...
      >
        <slot name="nextText" v-if="hasNextContent"></slot>
...
export default {
  ...
  computed: {
    hasPrevContent() {
      return !!this.$slots["prevText"];
    },
    hasNextContent() {
      return !!this.$slots["nextText"];
    },
    selected: {
      get: function() {
